            ...
            <div className="bg-[#F9FAFB]">
                <section className="py-16 px-6 md:px-12 lg:px-24">
                    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
                        ...
                        {/* Story Column */}
                        <div className="bg-white p-8 rounded-lg">
                            <h2 className="text-xl font-bold text-[#520052] mb-2">Our Story</h2>
                            <p className="text-gray-700">
                                Born out of the need for simple, effective, and automated advertising, Genz.ad was founded by a team of passionate designers, marketers, and AI experts. We saw a gap: small businesses struggling with ad creation, wasting time and money on complex tools.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-16 px-6 md:px-12 lg:px-24 bg-gray-50">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <p className="text-center text-[#121316] mb-12 max-w-[1201px]">
                            We ensure your ideas and creations reach the right audience. Our AI-powered platform simplifies ad generation, helping you craft localized, inclusive, and high-performing campaigns. From AI-driven suggestions to simple customization and multi-platform publishing, we make sure your message is delivered with impact.
                        </p>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white p-8 rounded-lg shadow-sm text-center">
                                <div className="w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-6">
                                    <svg width="61" height="60" viewBox="0 0 61 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M28.166 10H10.666C9.33993 10 8.06816 10.5268 7.13048 11.4645C6.1928 12.4021 5.66602 13.6739 5.66602 15V50C5.66602 51.3261 6.1928 52.5979 7.13048 53.5355C8.06816 54.4732 9.33993 55 10.666 55H45.666C46.9921 55 48.2639 54.4732 49.2015 53.5355C50.1392 52.5979 50.666 51.3261 50.666 50V32.5" stroke="#B800B8" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M46.916 6.24996C47.9106 5.25539 49.2595 4.69666 50.666 4.69666C52.0725 4.69666 53.4215 5.25539 54.416 6.24996C55.4106 7.24452 55.9693 8.59343 55.9693 9.99996C55.9693 11.4065 55.4106 12.7554 54.416 13.75L30.666 37.5L20.666 40L23.166 30L46.916 6.24996Z" stroke="#B800B8" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <h3 className="text-lg font-semibold mb-4">Localized & Inclusive Ads</h3>
                                <p className="text-gray-600 text-sm">
                                    Edit text, images, and layouts with a live preview for instant updates, ensuring a smooth workflow.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-16 px-6 md:px-[75px] lg:px-24 bg-[#520052] text-white w-[1248px] mx-auto rounded-[16px]">
                    <div className="mx-auto">
                        <h2 className="text-2xl md:text-3xl font-bold text-center mb-12">People Behind Genz.ad</h2>
                ...
                <section className="py-16 px-6 md:px-12 lg:px-24">
                    <div className="mx-auto grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            <h2 className="text-2xl md:text-3xl font-bold mb-6">Turn Ideas into Stunning Visuals Instantly</h2>
                ...
                <section className="py-16 px-6 md:px-12 lg:px-24 bg-[#F8E6F8] rounded-[16px]">
                    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                        {/* Left - CTA Text */}
                        <div>
                            <h2 className="text-2xl md:text-3xl font-bold mb-6">We help small businesses grow faster & smarter</h2>
                            <p className="text-gray-700 mb-8">
                                We understand small businesses need faster and smarter ways to drive ad creation. Our platform simplifies marketing, enhances engagement, and helps businesses reach the right audience effortlessly.
                            </p>
                            <motion.div
                ...
                <section className="py-12 px-6 md:px-12 lg:px-24 bg-gray-50 text-center">
                    <div className="max-w-4xl mx-auto">
                        <p className="text-gray-600 text-sm">
                            genz.ad helps you generate image ads tailored for different platforms, audiences and cultural contexts, without needing design or marketing expertise.
                        </p>
                    </div>
                </section>
            </div>
