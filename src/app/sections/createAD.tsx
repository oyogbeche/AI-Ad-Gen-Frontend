...
const CreateAd: React.FC = () => {
  ...
  <ul className="mt-6 space-y-4">
    <li className="flex items-center gap-2">
      <CheckCircle className="text-[#EC802E]" size={20} /> Create compelling ads
    ...
    <li className="flex items-center gap-2">
      <CheckCircle className="text-[#EC802E]" size={20} /> Launch professional
      ads at affordable prices
    </li>
    <li className="flex items-center gap-2">
      <CheckCircle className="text-[#EC802E]" size={20} /> Optimize your ads for
